...
export default function CreateSpotModal() {
  ...
  const validate = () => {
    ...
    if (
      ...
      err.img2 = "Image URL must end in .png, .jpg, or .jpeg";
    if (
      img3 &&
      (!img3.endsWith(".png") ||
        !img3.endsWith(".jpg") ||
      ...
      err.img3 = "Image URL must end in .png, .jpg, or .jpeg";
    if (
      img4 &&
      (!img4.endsWith(".png") ||
        !img4.endsWith(".jpg") ||
    ...
    if (
      ...
      err.img5 = "Image URL must end in .png, .jpg, or .jpeg";
    setErrors(err);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    dispatch(
      createSpotImageBackEnd({ spotId: spot?.id, preview: true, url: img1 })
    )
      .then(() => {
        setImg1(null);
      })
    ...
    if (img2)
      dispatch(
        createSpotImageBackEnd({ spotId: spot.id, url: img2, preview: true })
      );
    if (img3)
      dispatch(
        createSpotImageBackEnd({ spotId: spot.id, url: img3, preview: true })
      );
    if (img4)
      dispatch(
        createSpotImageBackEnd({ spotId: spot.id, url: img4, preview: true })
      );
    if (img5)
      dispatch(
        createSpotImageBackEnd({ spotId: spot.id, url: img5, preview: true })
      );
    closeModal();
  ...
  return (
    <div className="create-spot-modal">
      <form className="create-form" onSubmit={handleSubmit}>
        ...
        <hr />
        <h3 className="create-subtitle create-title">
        ...
        <hr />
        <h3 className="create-price create-subtitle">
          Set a base price for your spot
        </h3>
        <label className="create-label">
          Competetive pricing can help your listing stand out and rank higher in
          search results.
        </label>
        <input
        ...
        <label className="create-label">
          Submit at least one photo to publish your spot
        </label>
        <div className="aws">
          <input
