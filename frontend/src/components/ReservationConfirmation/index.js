...
export default function ReservationConfirmation() {
  ...
  const booking =
    bookings && bookings.length
      ? bookings.find((b) => b["id"] === parseInt(bookingId))
      : null;
  ...
  console.log(
    "BOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOKINGS",
    bookings.find((b) => b["id"] === parseInt(bookingId))
  );
  return (
      ...
      <div className="reservation-content">
        <div className="reservation-left">
          ...
          <h4 className="reservation-title">
            You're going to {booking.Spot.city}!
          </h4>
          <img
            className="reservation-img"
            src={booking.SpotImages[0].url}
            alt=""
          />
          ...
          <div className="reservation-header">
            <div className="reesrvation-header-left-side">
              <div className="reservation-intro">
                Cozy spot in the heart {booking.Spot.city}
              </div>
              <div className="reservation-grey-text">
                Entire home/apt by {booking.Owner.firstName}
              </div>
            </div>
            ...
            <img
              ...
              alt="user-icon"
              className="reservation-user-icon"
            />
          </div>
          ...
          <div className="reservation-checkin">
            <div>
              <span className="checkin-deets">
                {startDate.toString().split(" ")[0]},
              </span>
              <span className="checkout-deets">
                {endDate.toString().split(" ")[0]}
              </span>
            </div>
            <div>
              <span className="checkin-deets">
                {startDate.toString().slice(3, 15)}
              </span>
              <span className="checkout-deets">
                {endDate.toString().slice(3, 15)}
              </span>
            </div>
            <div>
          ...
          <div className="full-iternary" onClick={onClick}>
            View full iternary
          </div>
        </div>
        ...
        <div className="reservation-right">
          ...
          <div className="reservation-subtitle">
            {booking.Owner.firstName} is your host
          </div>
          <div>
            Contact {booking.Owner.firstName} to coordinate arrival time and key
            exchange.
          </div>
          <hr></hr>
