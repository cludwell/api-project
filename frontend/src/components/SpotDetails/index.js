...
export default function SpotDetails() {
    ...
    const reviewStats = singleSpot.numReviews === 0 ? (<>
    ...
    <>
        <div className='spot-details'>
            ...
            <div className='price-review-reserve'>
                ...
                <span className='reserve-right'>{reviewStats}</span>
        ...
        <div className='reviews-printed'>
            <h1>{reviewStats}</h1>
            {spotReviews.length ? spotReviews.sort((a,b)=>Date.parse(b.createdAt)-Date.parse(a.createdAt))
            .map((rev, i) => (
                <>
